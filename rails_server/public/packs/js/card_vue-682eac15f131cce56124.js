...
document.addEventListener('DOMContentLoaded', function () {
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    template: '<div>card_vue: {{varName.first}}<ul><li v-for="character in characters">{{ character }}</li></ul></div>',
    data: {
      games: {
        varName: null
      },
      characters: ['Isaac', 'Yuki', 'Junki']
    },
...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/Users/Isaac/code/Kodingroo/boardgame_api/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAiBA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue?vue&type=style&index=0&id=6fb8108a&scoped=true&lang=css&","sourcesContent":["<template>\n  <div id=\"app\">\n    <p>{{ message }}</p>\n  </div>\n</template>\n\n<script>\nexport default {\n  data: function () {\n    return {\n      message: \"Hello Vue!\"\n    }\n  }\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
...
/******/ });
//# sourceMappingURL=card_vue-682eac15f131cce56124.js.map